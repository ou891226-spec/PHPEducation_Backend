...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='題目與知識卡';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `question_knowledge_cards` VALUES (1,1,28,'2026-08-25 12:28:10','2026-08-25 12:28:10'),(2,2,28,'2026-08-25 12:28:10','2026-08-25 12:28:10'),(3,3,28,'2026-08-25 12:28:10','2026-08-25 12:28:10'),(4,4,2,'2026-08-30 15:54:50','2026-08-30 15:54:50'),(5,5,29,'2026-09-01 13:17:33','2026-09-01 13:17:33'),(6,6,29,'2026-09-01 13:33:42','2026-09-01 13:33:42'),(7,7,29,'2026-09-01 13:34:55','2026-09-01 13:34:55'),(8,8,29,'2026-09-01 14:38:06','2026-09-01 14:38:06'),(9,9,29,'2026-09-01 15:01:45','2026-09-01 15:01:45'),(10,10,29,'2026-09-01 15:17:27','2026-09-01 15:17:27');
...
INSERT INTO `question_options` VALUES (1,1,'A','變數名稱前面要加 $',1,2,'2026-08-25 12:28:10','2026-08-25 12:28:10'),(2,1,'B','這不是正解',0,1,'2026-08-25 12:28:10','2026-08-25 12:28:10'),(9,4,'$arr = [1, 2, 3];',NULL,1,2,'2026-09-01 13:21:46','2026-09-01 13:21:46'),(10,4,'$arr = (1, 2, 3);',NULL,0,1,'2026-09-01 13:21:46','2026-09-01 13:21:46'),(11,4,'arr = [1, 2, 3];',NULL,0,1,'2026-09-01 13:21:46','2026-09-01 13:21:46'),(12,4,'$arr := [1, 2, 3];',NULL,0,1,'2026-09-01 13:21:46','2026-09-01 13:21:46'),(13,5,'是','== 主要比較值；=== 才會同時比較值與型別',0,1,'2026-09-01 13:22:06','2026-09-01 13:22:06'),(14,5,'否','== 主要比較值；=== 才會同時比較值與型別',1,2,'2026-09-01 13:22:06','2026-09-01 13:22:06'),(17,6,'是','$user = [     \"name\" => \"Tom\",     \"age\" => 20 ];',0,1,'2026-09-01 13:36:37','2026-09-01 13:36:37'),(18,6,'否','$user = [     \"name\" => \"Tom\",     \"age\" => 20 ];',1,2,'2026-09-01 13:36:37','2026-09-01 13:36:37');
...
INSERT INTO `question_record_subs` VALUES (1,6,3,'$name = \"Ada\";',1,2,'2026-08-30 16:33:15','2026-08-30 16:33:15'),(2,23,1,';',1,2,'2026-09-01 14:38:16','2026-09-01 14:38:16'),(3,24,2,'$name = \"Tom\"；',1,2,'2026-09-01 14:44:17','2026-09-01 14:44:17'),(4,25,1,'20',1,2,'2026-09-01 15:03:50','2026-09-01 15:03:50');
...
INSERT INTO `question_sub_answers` VALUES (1,2,3,'$name = \"Ada\";','第 3 行變數少了 $',2,'2026-08-30 16:01:48','2026-08-30 16:01:48'),(2,7,1,';',NULL,2,'2026-09-01 13:34:55','2026-09-01 13:34:55'),(3,8,2,'$name = \"Tom\";','PHP 敘述結尾缺少分號 ;',2,'2026-09-01 14:38:06','2026-09-01 14:38:06'),(4,9,1,'20','PHP 陣列的索引從 0 開始，因此：\n$numbers[0] → 10\n$numbers[1] → 20\n$numbers[2] → 30\n所以輸出 20。',2,'2026-09-01 15:01:45','2026-09-01 15:01:45');
...
INSERT INTO `questions` VALUES (1,2,2,'PHP 變數符號','choice','PHP 宣告變數時，名稱前面要加什麼符號？','B11',NULL,0,NULL,NULL,NULL,'2026-08-25 12:28:10','2026-08-30 16:01:48'),(2,2,2,'找出少了錢字號','debug','下列程式哪一行少了 $？\n1 echo \"hi\";\n2 $age = 21;\n3 name = \"Ada\";','B41',NULL,0,NULL,NULL,NULL,'2026-08-25 12:28:10','2026-08-30 16:01:48'),(3,2,2,'輸出 hello','coding','請寫一段 PHP，輸出 hello。','B31',NULL,0,NULL,NULL,NULL,'2026-08-25 12:28:10','2026-08-30 16:01:48'),(4,2,2,'PHP選擇01','choice','以下哪一個是正確的 PHP 陣列宣告？','B11','記憶',0,NULL,NULL,NULL,'2026-08-30 15:54:50','2026-09-01 13:21:46'),(5,2,2,'PHP是非01','true_false','PHP 使用 == 比較兩個變數時，會同時檢查資料型別','B13','記憶',0,NULL,NULL,NULL,'2026-09-01 13:17:33','2026-09-01 13:22:06'),(6,2,2,'PHP是非02','true_false','PHP 陣列的索引只能使用數字，不能使用字串','B23',NULL,0,NULL,NULL,NULL,'2026-09-01 13:33:42','2026-09-01 13:33:42'),(7,2,2,'PHP填空01','fill','PHP 程式碼通常以 （1）作為結束標記','B33',NULL,0,NULL,NULL,NULL,'2026-09-01 13:34:55','2026-09-01 13:34:55'),(8,2,2,'PHP除錯01','debug','請找出以下 PHP 程式的錯誤並修正\n<!--debug-code-->\n1. <?php\n2. $name = \"Tom\"\n3. echo $name;','B41',NULL,0,NULL,NULL,NULL,'2026-09-01 14:38:06','2026-09-01 14:38:06'),(9,2,2,'PHP解讀01','interpret','請解讀以下 PHP 程式，說明最後會輸出什麼\n<!--code-stem-->\n$numbers = [10, 20, 30];\necho $numbers[1];','B51',NULL,0,NULL,NULL,NULL,'2026-09-01 15:01:45','2026-09-01 15:01:45'),(10,2,2,'PHP實作01','coding','請使用 PHP 撰寫程式，判斷一個數字是否為偶數','B61',NULL,0,'$number = 8','奇數','$number = 8;\nif ($number % 2 == 0) {\n    echo \"偶數\";\n} else {\n    echo \"奇數\";\n}','2026-09-01 15:17:27','2026-09-01 15:17:27');
...
-- Dump completed on 2026-09-02 16:43:12
