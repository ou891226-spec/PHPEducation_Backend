...
CREATE TABLE `student_application_items` (
  ...
  `application_id` bigint unsigned NOT NULL COMMENT '申請 ID（教師編號）',
  ...
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新時間',
  PRIMARY KEY (`id`),
  UNIQUE KEY `student_application_items_application_student_no_unique` (`application_id`,`student_no`),
  KEY `student_application_items_application_id_foreign` (`application_id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='學生申請物件表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `student_applications` (
  `id` bigint unsigned NOT NULL COMMENT '教師編號',
  `class_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '申請班級',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '申請狀態',
  `created_at` timestamp NULL DEFAULT NULL COMMENT '建立時間',
  `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新時間',
  PRIMARY KEY (`id`),
  CONSTRAINT `student_applications_id_foreign` FOREIGN KEY (`id`) REFERENCES `teachers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='學生申請帳號表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='教師申請帳號表';
/*!40101 SET character_set_client = @saved_cs_client */;
